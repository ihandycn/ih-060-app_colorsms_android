...
public class InviteFriendsListItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public InviteFriendsListItemDecoration(int column, int itemWidth, int itemHeight) {
        mNumColumn = column;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mInitSpacing) {
            ...
            mVerticalSpacing = Dimensions.pxFromDp(21);
