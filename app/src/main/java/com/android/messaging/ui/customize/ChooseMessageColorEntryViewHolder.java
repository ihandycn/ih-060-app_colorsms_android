...
public class ChooseMessageColorEntryViewHolder extends BasePagerViewHolder implements CustomPagerViewHolder {
    private Context mContext;

    public ChooseMessageColorEntryViewHolder(final Context context) {
        mContext = context;
    }
