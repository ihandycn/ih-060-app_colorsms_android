...
import com.android.messaging.util.StringUtils;
...
public class PermissionGuideView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        tv.setText(StringUtils.capitalizeFirstLetter(context.getText(R.string.permission_guide_enable_button).toString()) + " " + context.getText(R.string.app_name));
