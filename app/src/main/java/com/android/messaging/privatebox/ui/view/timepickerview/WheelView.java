...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            HSLog.e("WheelView onDraw error!");
        }
        if (!isLoop) {//不循环的情况
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (isContentNumber) {
                    drawCenterContentStart += RADIAN_OFFSET * alphaF;
                    drawOutContentStart += RADIAN_OFFSET * alphaF;
                } else {
                    drawCenterContentStart += RADIAN_OFFSET * (1 - alphaF);
                    drawOutContentStart += RADIAN_OFFSET * (1 - alphaF);
                }
